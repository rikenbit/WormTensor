...
```
![Figure2a : Silhouette plots](Silhouette.png){width=100%}

![Figure2b : Dimensional reduction Plots colored by cluster](Cluster.png){width=100%}

![Figure2c : Dimensional reduction Plots colored by no. of identified cells](no_identified.png){width=100%}

![Figure2d : ARI with a merge result and each animal(with MCMI)](weight_ARI_no.png){width=100%}
