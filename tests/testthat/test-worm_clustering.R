...
expect_equal(length(object_mcmi@clustering),
    object_mcmi@n_union_cells)
expect_equal(dim(object_mcmi@factor),
    c(object_mcmi@n_union_cells, object_mcmi@k))
expect_equal(length(object_mcmi@weight),
...
expect_equal(length(object_oindscal@clustering),
    object_oindscal@n_union_cells)
expect_equal(dim(object_oindscal@factor),
...
expect_equal(length(object_cspa@clustering),
    object_cspa@n_union_cells)
expect_equal(dim(object_cspa@consensus),
